...
class PoliticianInfoAdmin(admin.ModelAdmin):
    ...
    list_display = ['name', 'email', 'is_active', 'seimas_politician', 'mayor_candidate', 'president_candidate', 'mep_candidate', 'promise_count', 'created_at',
                    'updated_at']

    list_select_related = ['seimas_politician', 'mayor_candidate', 'mep_candidate', 'president_candidate']
    inlines = [PoliticianPromiseInline]
    raw_id_fields = ['seimas_politician', 'mayor_candidate', 'president_candidate', 'mep_candidate', 'authenticated_users']
